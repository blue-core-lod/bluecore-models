...
def upgrade() -> None:
    ...
    op.create_table('bibframe_classes',
    ...
    op.create_table('other_resources',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('is_profile', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['resource_base.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('resource_bibframe_classes',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('bf_class_id', sa.Integer(), nullable=False),
    sa.Column('resource_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['bf_class_id'], ['bibframe_classes.id'], ),
    sa.ForeignKeyConstraint(['resource_id'], ['resource_base.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('bibframe_other_resources',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('other_resource_id', sa.Integer(), nullable=False),
    sa.Column('bibframe_resource_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['bibframe_resource_id'], ['resource_base.id'], ),
    sa.ForeignKeyConstraint(['other_resource_id'], ['other_resources.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
