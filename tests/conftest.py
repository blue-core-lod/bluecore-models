...
def create_test_rows():
    ...
    return Rows(
        Work(
            ...
            created_at=time_now,
            updated_at=time_now,
            data=json.load(pathlib.Path("tests/data/blue-core-work.jsonld").open()),
        ...
        Instance(
            ...
            created_at=time_now,
            updated_at=time_now,
            data=json.load(pathlib.Path("tests/data/blue-core-instance.jsonld").open()),
            type="instances",
        ...
        Hub(
            ...
            created_at=time_now,
            updated_at=time_now,
            data=json.load(pathlib.Path("tests/data/blue-core-hub.jsonld").open()),
